...
const Transactions = () => {
    ...
    if (data) {
        ...
        return(<>
                ...
                <TransactionsForDay date={transaction_by_day.date} transactions={transaction_by_day.transactions}></TransactionsForDay> */}
                <TransactionsForDay date={transactionData.data.date} transactions={transactionData}></TransactionsForDay>
        ...
        return <Button name="Secondary button" onClick={() => handleOnModalChange('add_stock')} secondary value="add_stock" style={{ height: '100%' }}>
            Add Stock
        </Button>
 }
