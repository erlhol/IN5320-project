      ...
      <Modal onClose={() => props.onClose()} position='middle'>
        ...
        <ModalContent >
          <Box height="360px">
            <div className={classes.transDetailTimeAndRecipientContainer}>
              <div className={classes.transDetailTimeContainer}>
                ...
                <div className={classes.transDetailTimeText}>
                  <p>Date and Time</p>
                  <p className={classes.bold}>{props.transaction.date + " " + props.transaction.time}</p>
                </div>
              </div>
            ...
            <div className={classes.transDetailTableCaption}>{props.transType} Commodities</div>
            <Table>
              <TableHead>
                <TableRowHead>
              ...
              <TableBody>
                {props.transaction.commodities.map((commodity, i) => (
                  <TableRow key={i}>
                    <TableCell width={spacers.dp250}>{commodity.commodityName}</TableCell>
